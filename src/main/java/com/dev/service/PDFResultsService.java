...
@Service
public class PDFResultsService {
	...
	public ByteArrayInputStream generatePDF(Test test) throws DocumentException, MalformedURLException, IOException{
		...
		testTable.addCell(createCell(test.getDate().format(formatter), textfont_B, Element.ALIGN_MIDDLE, Element.ALIGN_LEFT, 0, 0, 0));
		doc.add(testTable);
